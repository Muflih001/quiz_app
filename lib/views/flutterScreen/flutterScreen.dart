...
class _FlutterScreenState extends State<FlutterScreen> {
            ...
            children: [
                ...
                child: Row(
                  ...
                  children: [
                    LinearPercentIndicator(
                      ...
                      //animation: true,
                      lineHeight: 13.0,
                      percent: (_currentIndex + 1) / DummyDB.questions.length,
                      barRadius: Radius.circular(10),
                      progressColor: Colors.orange,
                    ),
                    Text(
                      ' ${_currentIndex + 1} / ${DummyDB.questions.length}',
              ...
              Container(
                ...
                child: Padding(
                  ...
                  child: Text(
                    DummyDB.questions[_currentIndex]['question'].toString(),
              ...
              Column(
                children: [
                  ...List.generate(4, (index) {
                    List options =
                        DummyDB.questions[_currentIndex]['options'] as List;
                    return optionCard(
                      ...
                      isCorrect: _selectedAnswer != null &&
                          _selectedAnswer == options[index] &&
                          index ==
                              (DummyDB.questions[_currentIndex]['correctanswer']
                                      as int) -
                                  1,
                    );
                  }),
                        ...
                        Navigator.push(
                          ...
                          MaterialPageRoute(
                              builder: (context) => ResultScreen(
                                    ...
                                    totalQuestions: DummyDB.questions.length,
  ...
  void goToNextQuestion() {
    setState(() {
      if (_currentIndex < DummyDB.questions.length - 1) {
