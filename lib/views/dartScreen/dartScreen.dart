            ...
            children: [
                ...
                child: Row(
                  ...
                  children: [
                    LinearPercentIndicator(
                      ...
                      //animation: true,
                      lineHeight: 13.0,
                      percent: (_currentIndex + 1) / DartDB.questions.length,
                      barRadius: Radius.circular(10),
                      progressColor: Colors.orange,
                    ),
                    Text(
                      ' ${_currentIndex + 1} / ${DartDB.questions.length}',
              ...
              Container(
                ...
                child: Padding(
                  ...
                  child: Text(
                    DartDB.questions[_currentIndex]['question'].toString(),
              ...
              Column(
                children: [
                  ...List.generate(4, (index) {
                    List options =
                        DartDB.questions[_currentIndex]['options'] as List;
                    return optionCard(
                      ...
                      isCorrect: _selectedAnswer != null &&
                          _selectedAnswer == options[index] &&
                          index ==
                              (DartDB.questions[_currentIndex]['correctanswer']
                                      as int) -
                                  1,
                    );
                  }),
                        ...
                        Navigator.push(
                          ...
                          MaterialPageRoute(
                              builder: (context) => ResultScreen(
                                    ...
                                    totalQuestions: DartDB.questions.length,
