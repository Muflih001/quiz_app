            ...
            children: [
                ...
                child: Row(
                  ...
                  children: [
                    LinearPercentIndicator(
                      ...
                      //animation: true,
                      lineHeight: 13.0,
                      percent: (_currentIndex + 1) / PhysicsDB.questions.length,
                      barRadius: Radius.circular(10),
                      progressColor: Colors.orange,
                    ),
                    Text(
                      ' ${_currentIndex + 1} / ${PhysicsDB.questions.length}',
              ...
              Container(
                ...
                child: Padding(
                  ...
                  child: Text(
                    PhysicsDB.questions[_currentIndex]['question'].toString(),
              ...
              Column(
                children: [
                  ...List.generate(4, (index) {
                    List options =
                        PhysicsDB.questions[_currentIndex]['options'] as List;
                    return optionCard(
                      ...
                      isCorrect: _selectedAnswer != null &&
                          _selectedAnswer == options[index] &&
                          index ==
                              (PhysicsDB.questions[_currentIndex]['correctanswer']
                                      as int) -
                                  1,
                    );
                  }),
                        ...
                        Navigator.push(
                          ...
                          MaterialPageRoute(
                              builder: (context) => ResultScreen(
                                  skippedQuestions: _skippedQuestions, totalQuestions: PhysicsDB.questions.length,correctAnswers: _correctAnswers,
                                  )),
                        );
                      }
                    },
...
void goToPreviousQuestion() {
 ...
 void goToNextQuestion() {
    setState(() {
      if (_currentIndex < PhysicsDB.questions.length - 1) {
      ...
      _selectedAnswer = null;
        ...
        Navigator.push(
          ...
          MaterialPageRoute(
              builder: (context) =>
                  ResultScreen(skippedQuestions: _skippedQuestions,totalQuestions: PhysicsDB.questions.length,correctAnswers: _correctAnswers,)),
        );
      }
    });
  }
