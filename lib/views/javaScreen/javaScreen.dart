...
class _JavaScreenState extends State<JavaScreen> {
            ...
            children: [
                ...
                child: Row(
                  ...
                  children: [
                    LinearPercentIndicator(
                      ...
                      //animation: true,
                      lineHeight: 13.0,
                      percent: (_currentIndex + 1) / JavaDB.questions.length,
                      barRadius: Radius.circular(10),
                      progressColor: Colors.orange,
                    ),
                    Text(
                      ' ${_currentIndex + 1} / ${JavaDB.questions.length}',
              ...
              Container(
                ...
                child: Padding(
                  ...
                  child: Text(
                    JavaDB.questions[_currentIndex]['question'].toString(),
              ...
              Column(
                children: [
                  ...List.generate(4, (index) {
                    List options =
                        JavaDB.questions[_currentIndex]['options'] as List;
                    return optionCard(
                      ...
                      isCorrect: _selectedAnswer != null &&
                          _selectedAnswer == options[index] &&
                          index ==
                              (JavaDB.questions[_currentIndex]['correctanswer']
                                      as int) -
                                  1,
                    );
                  }),
                        ...
                        Navigator.push(
                          ...
                          MaterialPageRoute(
                              builder: (context) => ResultScreen(
                                    totalQuestions: JavaDB.questions.length,
  ...
  void goToNextQuestion() {
    setState(() {
      if (_currentIndex < JavaDB.questions.length - 1) {
      ...
      _selectedAnswer = null;
        ...
        Navigator.push(
          ...
          MaterialPageRoute(
              builder: (context) =>
                  ResultScreen(skippedQuestions: _skippedQuestions,totalQuestions: JavaDB.questions.length,correctAnswers: _correctAnswers,)),
        );
      }
    });
  }
