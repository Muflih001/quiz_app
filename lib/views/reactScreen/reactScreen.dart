...
class _ReactScreenState extends State<ReactScreen> {
            ...
            children: [
                ...
                child: Row(
                  ...
                  children: [
                    LinearPercentIndicator(
                      ...
                      //animation: true,
                      lineHeight: 13.0,
                      percent: (_currentIndex + 1) / ReactDB.questions.length,
                      barRadius: Radius.circular(10),
                      progressColor: Colors.orange,
                    ),
                    Text(
                      ' ${_currentIndex + 1} / ${ReactDB.questions.length}',
              ...
              Container(
                ...
                child: Padding(
                  ...
                  child: Text(
                    ReactDB.questions[_currentIndex]['question'].toString(),
              ...
              Column(
                children: [
                  ...List.generate(4, (index) {
                    List options =
                        ReactDB.questions[_currentIndex]['options'] as List;
                    return optionCard(
                      ...
                      isCorrect: _selectedAnswer != null &&
                          _selectedAnswer == options[index] &&
                          index ==
                              (ReactDB.questions[_currentIndex]['correctanswer']
                                      as int) -
                                  1,
                    );
                  }),
  ...
  void goToNextQuestion() {
    setState(() {
      if (_currentIndex < ReactDB.questions.length - 1) {
